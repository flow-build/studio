...
const Diagram = () => {
  ...
  useEffect(() => {
	return () => {
		console.log('Leaving Diagram Page'); 
  ...
  return (
    <Grid className="testeeee" container spacing={1}>
      <Grid
        item
        xs={12}
        sx={{
      ...
      >
        ...
        <Stack direction="row" spacing={1}>
          ...
          <Button variant="contained" onClick={handleToggleProcessDrawer}>
            Listar Processos
          </Button>
